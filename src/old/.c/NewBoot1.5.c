...
/*
            ...
            ------ NewBoot -- version 1.5 -- 16-Aug-90 15:21 ------
...
LONG DeleteFile(),Examine(),Read(),SetSignal();
...
char toupper();
long dos_packet();
void exit(),strncpy(); /* ,printf(),sprintf(); */
...
char **argv;
{
   ...
   if (argc != 16) {
      printf("NewBoot 1.5 -- Copyright (C) 1990 by Matthias Schmidt\n");
