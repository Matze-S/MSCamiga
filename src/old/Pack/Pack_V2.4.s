...
PackDirExNextOk:
	...
	lsr.l	#2,d1
	move.l	d1,-(sp)
	tst.l	(ArgBuffer+16)(a1)
	bne.s	NoDirPackedTxt
...
UnpackDirErrorNoCD:
	...
	cnop	0,4
ArgsTxt:
	dc.b	51,'FROM/A,TO/A,CREATE/S,EXTRACT/S,QUIET/S,BUF=BUFFER/K'
...
BadArgsTxt:
	...
	cnop	0,4
InvalidBufTxt:
	dc.b	25,'Invalid buffer argument!',10

	cnop	0,4
NotEnoughMemTxt:
	dc.b	30,'Not enough memory for buffer!',10
...
NoInputTxt:
	...
	cnop	0,4
CantWriteTxt:
	dc.b	27,10,10,'Error while writing %S - '

	cnop	0,4
FileIncompleteTxt:
	dc.b	34,'Pack-File "%S" may be incomplete!',10
...
CantExamineTxt:
	...
	cnop	0,4
IsFileNotDirTxt:
	dc.b	33,'"%S" is a file, not a directory!',10
...
PackingTxt:
	...
	cnop	0,4
CantReadTxt:
	dc.b	27,10,10,'Error while reading %S - '
