/*  SoftMMU - zur Beschleunigung des OS auf 32 - Bit - Amigas */
...
UBYTE *argv[];
{
   ...
   if((RamEnd - RamStart) < OS_SIZE) getout(NOT_ENOUGH_MEM);

   (ULONG*)RamKickEB = RamKickEL = RamEnd;
   RamKickSB = (UBYTE*)RamKickSL = (UBYTE*)RamKickEL - OS_SIZE + 1;
